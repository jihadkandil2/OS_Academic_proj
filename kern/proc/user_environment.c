...
void env_free(struct Env *e)
{
	...
	// your code is here, remove the panic and write your code
	{
		...
		sched_remove_exit(e);
		pf_remove_env_page(e,(uint32)e->env_page_directory);
		env_page_ws_invalidate(e,(uint32)e->env_page_directory); //free LRU List
		pt_clear_page_table_entry(e->env_page_directory,(uint32)e->env_page_directory); //free all page tables
		pd_clear_page_dir_entry(e->env_page_directory,(uint32)e->env_page_directory); //free directory table
