...
inline struct WorkingSetElement* env_page_ws_list_create_element(struct Env* e, uint32 virtual_address)
{
	...
	// Write your code here, remove the panic and write your code
	 ...
	 uint32 elementSize = sizeof(struct WorkingSetElement);           // jihad modifies the type of size to uint32
	 struct WorkingSetElement *New_element = (struct WorkingSetElement *)kmalloc(elementSize);
     void* returnedAddress=  New_element;    // returned add from kmalloc
     ...
     {
    	 panic("can not create this element");
    	 return NULL;
     }
	return NULL;
}
